...
namespace BottomTabBarDemo
{
    ...
    public partial class ScrollableTabPage : ContentPage
    {
        public ICommand TabItemCommand { get; set; }

        public ScrollableTabPage()
        {
            InitializeComponent();

            TabItemCommand = new Command<TabItem>(OnTabItemClicked);
            ...
            tabs.Add(new TabItem() { Id = 6, Icon = "email_red.png", SelectedIcon = "email_white.png", Name = "New Email", });
            tabs.Add(new TabItem() { Id = 7, Icon = "moon_red.png", SelectedIcon = "moon_white.png", Name = "Moon", });
            tabs.Add(new TabItem() { Id = 8, Icon = "headphones_red.png", SelectedIcon = "headphones_white.png", Name = "Song" });
        ...
        private void OnTabItemClicked(TabItem tabItem)
        {
            // Tab Item Click 
        }
